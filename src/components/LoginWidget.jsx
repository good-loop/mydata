	...
	return (
		...
		>
			...
			<div className="form-group">
				<label>App</label>
				<Misc.PropControl type='select' path={path} item={person} prop='app' 
					options={['youagain', 'datalog', 'goodloop', 'sogive']} />
			</div>
			<div className="form-group">
				<label>Email</label>
			...
			<Modal.Body>
				<div className="container-fluid">
					<div className="row">
						...
						<div className="col-sm-6">
							<SocialSignin verb={verb} services={['twitter', 'facebook']} />
						</div>
					</div>
				</div>
			</Modal.Body>
